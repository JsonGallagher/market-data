...
<div class="relative" bind:this={popoverRef}>
	...
	{#if isOpen}
		<div class="absolute top-full left-0 mt-2 z-50 bg-[#111111] border border-[#252525] rounded-lg shadow-xl p-4 min-w-[280px]">
			...
			<div class="space-y-3">
				<div>
					...
					<input
						...
						class="w-full px-3 py-2 bg-[#0a0a0a] border border-[#252525] rounded-md text-[#fafafa] text-sm
			...
			<div class="flex items-center gap-2 mt-4 pt-4 border-t border-[#252525]">
				<button
					type="button"
					onclick={handleClear}
					class="flex-1 px-3 py-2 text-sm font-medium text-[#a0a0a0] hover:text-[#fafafa] hover:bg-[#1a1a1a] rounded-md transition-colors"
				>
					Clear
				</button>
				<button
