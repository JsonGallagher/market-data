				...
				<FadeIn y={30} duration={0.6}>
					<div class="lux-card p-6 mb-10">
						...
						<div class="grid md:grid-cols-2 gap-8">
							<!-- Buyers Column -->
							<div class="space-y-4">
								<div class="flex items-center gap-3 pb-3 border-b border-[#252525]">
									...
									<h3 class="text-sm font-semibold text-[#fafafa] uppercase tracking-wider">For Buyers</h3>
								</div>
							...
							<div class="space-y-4">
								<div class="flex items-center gap-3 pb-3 border-b border-[#252525]">
									<div class="w-9 h-9 rounded-lg bg-[#d4a853]/10 border border-[#d4a853]/20 flex items-center justify-center">
										<svg class="w-5 h-5 text-[#d4a853]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
											<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
										</svg>
									</div>
									<h3 class="text-sm font-semibold text-[#fafafa] uppercase tracking-wider">For Sellers</h3>
								</div>
